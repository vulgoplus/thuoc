...
<div class="row">
	<div class="col-lg-12 adm-header">
		...
		<a href="{{url('admin/posts')}}" class="btn btn-primary btn-header"><i class="fa fa-bars"></i> &nbsp;&nbsp;Xem tất cả</a>
	</div>
</div><!--/.row-->
<div class="row">
	<div class="col-xs-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">Cập nhật trang</div>
			<div class="panel-body">
				{{Form::model($page, ['url' => 'admin/pages/'.$page->id, 'method' => 'put'])}}
                	...
                	<div class="form-group{{ $errors->has('content') ? ' has-error' : '' }}">
                	    <label for="content" class="control-label">Chi tiết <span class="error">*</span></label>
