...
<div class="row">
	<div class="col-lg-12 adm-header">
		...
		<a href="{{url('admin/taxonomies')}}" class="btn btn-primary btn-header"><i class="fa fa-bars"></i> &nbsp;&nbsp;Danh sách danh mục</a>
	</div>
</div><!--/.row-->
<div class="row">
	<div class="col-xs-12">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				{{Form::model($taxonomy, ['url' => 'admin/taxonomies/'.$taxonomy->id, 'method' => 'put'])}}
